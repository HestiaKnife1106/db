  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="enroll_course.php?id=<?= $c["id"] ?>" class="btn btn-success btn-sm">選課</a>
          <a href="edit_course.php?id=<?= $c["id"] ?>" class="btn btn-warning btn-sm">編輯</a>
          <a href="delete_course.php?id=<?= $c["id"] ?>" class="btn btn-danger btn-sm" onclick="return confirm('確定刪除？')">刪除</a>
        </td>
      </tr>
      <?php endforeach; ?>
    </tbody>
